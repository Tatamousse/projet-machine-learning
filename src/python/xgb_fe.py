...
print("RMSE validation :", rmse) #RMSE=8.7175
print("R² validation   :", r2) #r²=0.7863
...
submission.to_csv("../../submissions/submission_xgb_fe.csv", index=False)
print("submission_xgb_fe.csv généré") #SCORE KAGGLE : 8.68621
