...
print("\n ENSEMBLE 2 XGB")
print("Validation RMSE :", rmse) #RMSE=8.7136
print("Validation R²   :", r2) #r²=0.7865
...
submission.to_csv("../../submissions/submission_2_xgb_mean_fe.csv", index=False) 
print("\n submission_2_xgb_mean_fe.csv généré") # SCORE KAGGLE: 8.68262
